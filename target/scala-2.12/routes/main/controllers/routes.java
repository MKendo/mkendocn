...
public class routes {
  ...
  public static final controllers.ReverseCommonController CommonController = new controllers.ReverseCommonController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseCommonController CommonController = new controllers.javascript.ReverseCommonController(RoutesPrefix.byNamePrefix());
